// https://d3js.org Version 4.10.0. Copyright 2017 Mike Bostock.
    (function (t, n) {
        ...
        function or(t, n) {
            n = (n *= cd) / 2 + od;
            var e = (t *= cd) - Np, r = e >= 0 ? 1 : -1, i = r * e, o = hd(n), u = yd(n), a = Ep * u,
                c = Sp * o + a * hd(i), s = a * r * yd(i);
        ...
        function dr(t, n) {
            var e = ar([t * cd, n * cd]);
            if (Up) {
                var r = sr(Up, e), i = sr([r[1], -r[0], 0], r);
                hr(i), i = ur(i);
                var o, u = t - Rp, a = u > 0 ? 1 : -1, c = i[0] * ad * a, s = sd(u) > 180;
        ...
        function Sr(t, n) {
            t *= cd;
            var e = hd(n *= cd), r = e * hd(t), i = e * yd(t), o = yd(n),
        ...
        function Pr(t, n) {
            t *= cd;
            var e = hd(n *= cd), r = e * hd(t), i = e * yd(t), o = yd(n), u = Kp * o - td * i, a = td * r - Qp * o,
                c = Qp * i - Kp * r, s = md(u * u + a * a + c * c), f = Ge(s), l = s && -f / s;
        ...
        function Dr(t, n) {
            function e(t, n) {
                var e = hd(n), a = hd(t) * e, c = yd(t) * e, s = yd(n), f = s * r + a * i;
                return [ld(c * o - f * u, a * r - s * i), Ge(f * o + c * u)]
            }

            var r = hd(t), i = yd(t), o = hd(n), u = yd(n);
            return e.invert = function (t, n) {
                var e = hd(n), a = hd(t) * e, c = yd(t) * e, s = yd(n), f = s * o - c * u;
        ...
        function Br(t, n, e, r) {
            ...
            return function (u) {
                ...
                var l, h, p, d, v, _, y, g, m, x, b, w = u, M = Hd(), T = {
        ...
        function Xr(t, n) {
            t *= cd;
            var e = yd(n *= cd), r = hd(n), i = sd(t - Pd), o = hd(i), u = r * yd(i), a = Ld * e - Rd * r * o,
                c = Rd * e + Ld * r * o;
        ...
        function ci(t, n) {
            var e = t - Yd, r = n - Bd, i = md(e * e + r * r);
        ...
        function Ti(t, n, e) {
            ...
            var u = dv.result(), a = Math.min(r / (u[1][0] - u[0][0]), i / (u[1][1] - u[0][1])),
        ...
        function Si(t, n) {
            function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
                ...
                if (m > 4 * n && v--) {
                    var x = u + h, b = a + p, w = c + d, M = md(x * x + b * b + w * w), T = Ge(w /= M),
                        k = sd(sd(w) - 1) < ed || sd(o - l) < ed ? (o + l) / 2 : ld(b, x), N = t(k, T), S = N[0],
        ...
        function Pi(t, n) {
            ...
            var r = yd(t), i = (r + yd(n)) / 2;
            if (sd(i) < ed) return zi(t);
            var o = 1 + r * (2 * i - r), u = md(o) / i;
            return e.invert = function (t, n) {
                var e = u - n;
        ...
        function qi(t) {
            return function (n, e) {
                var r = md(n * n + e * e), i = t(r), o = yd(i), u = hd(i);
        ...
        function Di(t) {
            function n() {
                var n = rd * a(), u = o(jd(o.rotate()).invert([0, 0]));
        ...
        function Fi(t, n) {
            ...
            var r = hd(t), i = t === n ? yd(t) : vd(r / hd(n)) / vd(Oi(n) / Oi(t)), o = r * _d(Oi(t), i) / i;
            return i ? (e.invert = function (t, n) {
                var e = o - n, r = gd(i) * md(t * t + e * e);
        ...
        function Yi(t, n) {
            ...
            var r = hd(t), i = t === n ? yd(t) : (r - hd(n)) / (n - t), o = r / i + t;
        ...
        function Da(t, n, e, r, i, o, u) {
            var a = t - e, c = n - r, s = (u ? o : -o) / lg(a * a + c * c), f = s * c, l = -s * a, h = t + f, p = n + l,
                d = e + f, v = r + l, _ = (h + d) / 2, y = (p + v) / 2, g = d - h, m = v - p, x = g * g + m * m,
                b = i - o, w = h * v - d * p, M = (m < 0 ? -1 : 1) * lg(cg(0, b * b * x - w * w)),
        ...
        function $a(t) {
            function n() {
                var n, a = kg.call(arguments), c = e.apply(this, a), s = r.apply(this, a);
        ...
        function Za(t, n, e, r, i) {
            var o = Tg(n, e), u = Tg(n, e = (e + i) / 2), a = Tg(r, e), c = Tg(r, i);
        ...
        function qc(t) {
            return im[t.index] = {site: t, halfedges: []}
        }
        ...
        function Fc() {
            for (var t, n, e, r, i = 0, o = im.length; i < o; ++i) if ((t = im[i]) && (r = (n = t.halfedges).length)) {
        ...
        function Ic(t, n, e, r) {
            var i, o, u, a, c, s, f, l, h, p, d, v, _ = im.length, y = !0;
            ...
            if (n && e) {
                ...
                if (r !== o) {
                    ...
                    if (!(h >= -fm)) {
                        ...
                        for (var g = null, m = om._; m;) if (y.y < m.y || y.y === m.y && y.x <= m.x) {
                            if (!m.L) {
                                g = m.P;
                                break
                            }
        ...
        function Wc(t) {
            for (var n, e, r, i, o = t[0], u = t[1], a = rm._; a;) if ((r = Zc(a, u) - o) > sm) a = a.L; else {
                if (!((i = o - Gc(a, u)) > sm)) {
        ...
        function Kc(t, n) {
            ...
            for (um = [], im = new Array(t.length), rm = new Tc, om = new Tc; ;) if (i = em, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Wc(o), e = o[0], r = o[1]), o = t.pop(); else {
                if (!i) break;
                Vc(i.arc)
            }
            if (Fc(), n) {
        ...
        var Xh = function (t) {
                function n(t, n) {
                    function e() {
                        ...
                        for (; f < s;) {
                            var c = 1;
                            if (10 === (n = t.charCodeAt(f++))) i = !0; else if (13 === n) i = !0, 10 === t.charCodeAt(f) && (++f, ++c); else if (n !== o) continue;
                            return t.slice(e, f - c)
                        }
                        return t.slice(e)
                    }

                    for (var r, i, u = {}, a = {}, c = [], s = t.length, f = 0, l = 0; (r = e()) !== a;) {
            ...
            }, $h = Xh(","), Vh = $h.parse, Wh = $h.parseRows, Zh = $h.format, Gh = $h.formatRows, Jh = Xh("\t"),
            Qh = Jh.parse, Kh = Jh.parseRows, tp = Jh.format, np = Jh.formatRows, ep = function (t) {
                return function () {
                    return t
                }
            }, rp = function () {
        ...
        var up, ap = 10, cp = Math.PI * (3 - Math.sqrt(5)), sp = function (t, n) {
            ...
            "": function (t, n) {
                ...
                var e = sp(t, n);
                if (!e) return t + "";
                var r = e[0], i = e[1], o = i - (up = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
                    u = r.length;
            ...
            mp = function (t) {
                function n(t) {
                    ...
                    var a = (t = He(t)).fill, c = t.align, s = t.sign, f = t.symbol, l = t.zero, h = t.width,
                        ...
                        y = "$" === f ? r[1] : /[%p]/.test(v) ? u : "", g = dp[v], m = !v || /[defgprs%]/.test(v);
                    return d = null == d ? v ? 6 : 12 : /[gprs]/.test(v) ? Math.max(1, Math.min(21, d)) : Math.max(0, Math.min(20, d)), n.toString = function () {
                        return t + ""
                    }, n
                }

                var e = t.grouping && t.thousands ? lp(t.grouping, t.thousands) : yp, r = t.currency, i = t.decimal,
                    o = t.numerals ? hp(t.numerals) : yp, u = t.percent || "%";
                return {
                    format: n, formatPrefix: function (t, e) {
                        var r = n((t = He(t), t.type = "f", t)),
                            i = 3 * Math.max(-8, Math.min(8, Math.floor(fp(e) / 3))), o = Math.pow(10, -i),
                            u = gp[8 + i / 3];
                        return function (t) {
                            return r(o * t) + u
                        }
        ...
        var Tp, kp, Np, Sp, Ep, Ap, Cp, zp, Pp, Rp, Lp, qp, Up, Dp, Op, Fp, Ip, Yp, Bp, jp, Hp, Xp, $p, Vp, Wp, Zp, Gp,
            Jp, Qp, Kp, td, nd = new Ve, ed = 1e-6, rd = Math.PI, id = rd / 2, od = rd / 4, ud = 2 * rd, ad = 180 / rd,
            cd = rd / 180, sd = Math.abs, fd = Math.atan, ld = Math.atan2, hd = Math.cos, pd = Math.ceil, dd = Math.exp,
            vd = Math.log, _d = Math.pow, yd = Math.sin, gd = Math.sign || function (t) {
                return t > 0 ? 1 : t < 0 ? -1 : 0
            }, md = Math.sqrt, xd = Math.tan, bd = {
        ...
        }, Wd = 1e9, Zd = -Wd, Gd = Mp(), Jd = function (t, n) {
            var e = n[0], r = n[1], i = [yd(e), -hd(e), 0], o = 0, u = 0;
            Gd.reset();
            for (var a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + od, d = yd(p), v = hd(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
                var y = s[_], g = y[0], m = y[1] / 2 + od, x = yd(m), b = hd(m), w = g - h, M = w >= 0 ? 1 : -1,
                    T = M * w, k = T > rd, N = d * x;
        ...
        }, nv = [null, null], ev = {type: "LineString", coordinates: nv}, rv = function (t, n) {
        ...
        }, vv = 0, _v = 0, yv = 0, gv = 0, mv = 0, xv = 0, bv = 0, wv = 0, Mv = 0, Tv = {
        ...
        var Pv = function (t, n, e, r) {
            return function (i, o) {
                ...
                var p, d, v, _ = n(o), y = i.invert(r[0], r[1]), g = Hd(), m = n(g), x = !1, b = {
            ...
            var i;
            if (null == t) i = e * id, r.point(-rd, i), r.point(0, i), r.point(rd, i), r.point(rd, 0), r.point(rd, -i), r.point(0, -i), r.point(-rd, -i), r.point(-rd, 0), r.point(-rd, i); else if (sd(t[0] - n[0]) > ed) {
                var o = t[0] < n[0] ? rd : -rd;
                i = e * o / 2, r.point(-o, i), r.point(0, i), r.point(o, i)
            } else r.point(n[0], n[1])
        }, [-rd, -id]), Lv = function (t, n) {
            function e(t, n) {
                return hd(t) * hd(n) > o
            }
            ...
            return Pv(e, function (t) {
                ...
                return {
                    lineStart: function () {
                        ...
                        var p, d = [l, h], v = e(l, h), _ = u ? v ? 0 : i(l, h) : v ? i(l + (l < 0 ? rd : -rd), h) : 0;
                        if (!n && (s = c = v) && t.lineStart(), v !== c && (!(p = r(n, d)) || $d(n, p) || $d(d, p)) && (d[0] += ed, d[1] += ed, v = e(d[0], d[1])), v !== c) f = 0, v ? (t.lineStart(), p = r(d, n), t.point(p[0], p[1])) : (p = r(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p; else if (a && n && u ^ v) {
                            var y;
        ...
        var qv = 16, Uv = hd(30 * cd), Dv = function (t, n) {
        ...
        var jv = Array.prototype.slice, Hv = function (t) {
        ...
        }, Qv = (1 + Math.sqrt(5)) / 2, Kv = function t(n) {
        ...
        var i_ = function () {
            ...
            }, g_ = y_("text/csv", Vh), m_ = y_("text/tab-separated-values", Qh), x_ = Array.prototype, b_ = x_.map,
            w_ = x_.slice, M_ = {name: "implicit"}, T_ = function (t) {
                return function () {
                    return t
                }
            }, k_ = function (t) {
                return +t
            }, N_ = [0, 1], S_ = function (n, e, r) {
            ...
            }, A_ = new Date, C_ = new Date, z_ = Mu(function () {
            }, function (t, n) {
                t.setTime(+t + n)
            }, function (t, n) {
                return n - t
        ...
        var P_ = z_.range, R_ = 6e4, L_ = 6048e5, q_ = Mu(function (t) {
                ...
                return t.getDate() - 1
            }), B_ = Y_.range, j_ = Tu(0), H_ = Tu(1), X_ = Tu(2), $_ = Tu(3), V_ = Tu(4), W_ = Tu(5), Z_ = Tu(6),
            G_ = j_.range, J_ = H_.range, Q_ = X_.range, K_ = $_.range, ty = V_.range, ny = W_.range, ey = Z_.range,
            ry = Mu(function (t) {
        ...
        var uy = oy.range, ay = Mu(function (t) {
                t.setUTCSeconds(0, 0)
            }, function (t, n) {
                t.setTime(+t + n * R_)
            }, function (t, n) {
            ...
            }), hy = ly.range, py = ku(0), dy = ku(1), vy = ku(2), _y = ku(3), yy = ku(4), gy = ku(5), my = ku(6),
            xy = py.range, by = dy.range, wy = vy.range, My = _y.range, Ty = yy.range, ky = gy.range, Ny = my.range,
            Sy = Mu(function (t) {
        ...
        var Cy, zy = Ay.range, Py = {"-": "", _: " ", 0: "0"}, Ry = /^\s*\d+/, Ly = /^%/,
            qy = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
        Ma({
            dateTime: "%x, %X",
            date: "%-m/%-d/%Y",
        ...
        var Uy = Date.prototype.toISOString ? function (t) {
            ...
            } : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"), Dy = +new Date("2000-01-01T00:00:00.000Z") ? function (t) {
                var n = new Date(t);
                return isNaN(n) ? null : n
            } : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"), Oy = 1e3, Fy = 60 * Oy, Iy = 60 * Fy, Yy = 24 * Iy, By = 7 * Yy,
            jy = 30 * Yy, Hy = 365 * Yy, Xy = function (t) {
            ...
            Gy = wl($t(300, .5, 0), $t(-240, .5, 1)), Jy = wl($t(-100, .75, .35), $t(80, 1.5, .8)),
            Qy = wl($t(260, .75, .35), $t(80, 1.5, .8)), Ky = $t(),
            ...
            }, og = Math.abs, ug = Math.atan2, ag = Math.cos, cg = Math.max, sg = Math.min, fg = Math.sin,
            lg = Math.sqrt, hg = 1e-12, pg = Math.PI, dg = pg / 2, vg = 2 * pg;
        Oa.prototype = {
            areaStart: function () {
                this._line = 0
            }, areaEnd: function () {
        ...
        var _g = function (t) {
            ...
            var n = Fa, e = Ia, r = ig(!0), i = null, o = _g, u = null;
            ...
            var e = Fa, r = null, i = ig(0), o = Ia, u = ig(!0), a = null, c = _g, s = null;
        ...
        var wg = function () {
                ...
                var t = gg().curve(bg), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
                ...
                draw: function (t, n) {
                    var e = Math.sqrt(n / Ag), r = e * Eg;
                    t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
                }
            }, zg = Math.sin(pg / 10) / Math.sin(7 * pg / 10), Pg = Math.sin(vg / 10) * zg, Rg = -Math.cos(vg / 10) * zg,
            Lg = {
                draw: function (t, n) {
                    var e = Math.sqrt(.8908130915292852 * n), r = Pg * e, i = Rg * e;
                    t.moveTo(0, -e), t.lineTo(r, i);
                    for (var o = 1; o < 5; ++o) {
                        var u = vg * o / 5, a = Math.cos(u), c = Math.sin(u);
            ...
            }, Og = -.5, Fg = Math.sqrt(3) / 2, Ig = 1 / Math.sqrt(12), Yg = 3 * (Ig / 2 + 1), Bg = {
                draw: function (t, n) {
                    var e = Math.sqrt(n / Yg), r = e / 2, i = e * Ig, o = r, u = e * Ig + e, a = -o, c = u;
        ...
        Qa.prototype = {
            areaStart: Hg, areaEnd: Hg, lineStart: function () {
        ...
        var em, rm, im, om, um, am = [], cm = [], sm = 1e-6, fm = 1e-12;
        Kc.prototype = {
        ...
        t.version = "4.10.0", t.bisect = hs, t.bisectRight = hs, t.bisectLeft = ps, t.ascending = ss, t.bisector = fs, t.cross = function (t, n, r) {
            ...
            function n(n) {
                for (var e = 0, r = t.length; e < p; ++e) for (var i, a, c, f, l, h, d, v = 0; v < r; ++v) a = (i = t[v]).source, f = (c = i.target).x + c.vx - a.x - a.vx || rp(), l = c.y + c.vy - a.y - a.vy || rp(), f *= h = ((h = Math.sqrt(f * f + l * l)) - u[v]) / h * n * o[v], l *= h, c.vx -= f * (d = s[v]), c.vy -= l * d, a.vx += f * (d = 1 - d), a.vy += l * d
            }
            ...
            var i, o, u, a, c = ep(-30), s = 1, f = 1 / 0, l = .81;
            ...
            return Dp = Op = null, Ap === 1 / 0 || Cp === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Ap, Cp], [zp, Pp]]
        },t.geoCentroid = function (t) {
            Fp = Ip = Yp = Bp = jp = Hp = Xp = $p = Vp = Wp = Zp = 0, Md(t, Ad);
            var n = Vp, e = Wp, r = Zp, i = n * n + e * e + r * r;
            return i < 1e-12 && (n = Hp, e = Xp, r = $p, Ip < ed && (n = Yp, e = Bp, r = jp), (i = n * n + e * e + r * r) < 1e-12) ? [NaN, NaN] : [ld(e, n) * ad, Ge(r / md(i)) * ad]
        },t.geoCircle = function () {
            function t() {
                var t = r.apply(this, arguments), a = i.apply(this, arguments) * cd, c = o.apply(this, arguments) * cd;
            ...
            var n, e, r = Cd([0, 0]), i = Cd(90), o = Cd(6), u = {
                point: function (t, r) {
            ...
            var e = t[0] * cd, r = t[1] * cd, i = n[0] * cd, o = n[1] * cd, u = hd(r), a = yd(r), c = hd(o), s = yd(o),
                f = u * hd(e), l = u * yd(e), h = c * hd(i), p = c * yd(i),
                d = 2 * Ge(md(Je(o - r) + u * c * Je(i - e))), v = yd(d), _ = d ? function (t) {
                    var n = yd(t *= d) / v, e = yd(d - t) / v, r = e * f + n * h, i = e * l + n * p, o = e * a + n * s;
            ...
            var e, r, i, o, u, a, c = Iv(), s = Fv().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
                f = Fv().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
                    point: function (t, n) {
                        a = [t, n]
                    }
                };
            return t.invert = function (t) {
                ...
                return i = c.translate(t).clipExtent([[r - .455 * e, a - .238 * e], [r + .455 * e, a + .238 * e]]).stream(l), o = s.translate([r - .307 * e, a + .201 * e]).clipExtent([[r - .425 * e + ed, a + .12 * e + ed], [r - .214 * e - ed, a + .234 * e - ed]]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([[r - .214 * e + ed, a + .166 * e + ed], [r - .115 * e - ed, a + .234 * e - ed]]).stream(l), n()
            ...
            var n, e, r, i, o, u, a = 1, c = 0, s = 0, f = 1, l = 1, h = uv, p = null, d = uv;
            return u = {
                stream: function (t) {
            ...
            var e = Kv, r = !1, i = 1, o = 1, u = [0], a = To, c = To, s = To, f = To, l = To;
            return t.round = function (n) {
                return arguments.length ? (r = !!n, t) : r
            }, t.size = function (n) {
            ...
            function t() {
                var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments),
                    h = o.apply(this, arguments) - dg, p = u.apply(this, arguments) - dg, d = og(p - h), v = p > h;
                if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > hg) if (d > vg - hg) c.moveTo(l * ag(h), l * fg(h)), c.arc(0, 0, l, h, p, !v), f > hg && (c.moveTo(f * ag(p), f * fg(p)), c.arc(0, 0, f, p, h, v)); else {
                    var _, y, g = h, m = p, x = h, b = p, w = d, M = d, T = a.apply(this, arguments) / 2,
                        k = T > hg && (i ? +i.apply(this, arguments) : lg(f * f + l * l)),
                        N = sg(og(l - f) / 2, +r.apply(this, arguments)), S = N, E = N;
                    if (k > hg) {
                        var A = Ca(k / f * fg(T)), C = Ca(k / l * fg(T));
                        (w -= 2 * A) > hg ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2), (M -= 2 * C) > hg ? (C *= v ? 1 : -1, g += C, m -= C) : (M = 0, g = m = (h + p) / 2)
                    }
                    var z = l * ag(g), P = l * fg(g), R = f * ag(b), L = f * fg(b);
                    if (N > hg) {
                        var q = l * ag(m), U = l * fg(m), D = f * ag(x), O = f * fg(x);
                        if (d < pg) {
                            var F = w > hg ? Ua(z, P, D, O, q, U, R, L) : [R, L], I = z - F[0], Y = P - F[1],
                                B = q - F[0], j = U - F[1],
            ...
            var n = za, e = Pa, r = ig(0), i = null, o = Ra, u = La, a = qa, c = null;
            ...
            function t(t) {
                var a, c, s, f, l, h = t.length, p = 0, d = new Array(h), v = new Array(h),
                    _ = +i.apply(this, arguments), y = Math.min(vg, Math.max(-vg, o.apply(this, arguments) - _)),
            ...
            var n = xg, e = mg, r = null, i = ig(0), o = ig(vg), u = ig(0);
            return t.value = function (e) {
                return arguments.length ? (n = "function" == typeof e ? e : ig(+e), t) : n
            ...
            var n, e, r = t.length, i = t.map(bc), o = Kg(t).sort(function (t, n) {
                return i[n] - i[t]
            }), u = 0, a = 0, c = [], s = [];
        ...
        },t.zoomTransform = es,t.zoomIdentity = hm,Object.defineProperty(t, "__esModule", {value: !0})
    });